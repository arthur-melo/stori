...
const postWishlist = async (
  username: paths['/api/v1/wishlists/{username}/{bookId}']['post']['parameters']['path']['username'],
  bookId: paths['/api/v1/wishlists/{username}/{bookId}']['post']['parameters']['path']['bookId'],
) => {
